<template>
    <div>
        ...
        <h2 class="text-2xl font-semibold text-center mb-10">Sign In</h2>
        ...
        <div style="background-image: url('https://www.ptotjinzaibank.com/syokuba-kengaku/wp-content/uploads/sites/5/2021/04/101.jpg');"></div>
    </div>
</template>
...
export default {
    ...
    methods: {
        async loginUser() {
            try {
                const response = await axios.post('https://backend-blue-nine-65.vercel.app/login', {
