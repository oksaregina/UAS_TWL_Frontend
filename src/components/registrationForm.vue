...
export default {
    ...
    methods: {
        ...
        register() {
           // Tuliskan pernyataan if untuk memeriksa apakah data registrasi valid
           // Jika data tidak valid, tampilkan pesan toast dan keluar dari fungsi
            ...
            axios.post('https://backend-blue-nine-65.vercel.app/register', this.registrationData)
                .then(response => {
